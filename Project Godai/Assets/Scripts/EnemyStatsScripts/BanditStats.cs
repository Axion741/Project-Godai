...
public class BanditStats : MonoBehaviour, IEnemyStats{
    ...
    {
        //SpecialCase- Bandit Speed increases with level
        DetermineLevel();       
        
        //SetSpeedHere
        Speed = 8 + (EnemyLevel / 2);
    ...
    private void SetNametag()
    {
        ...
        characterName.text = "Bandit - Lv." + EnemyLevel;
    }
    ...
    private void AISetup()
    {
        ...
        enemyAbilities.punchMax = 60;
        enemyAbilities.powerUpMin = 60;
        enemyAbilities.powerUpMax = 70;
        enemyAbilities.barrageMin = 70;
